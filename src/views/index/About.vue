<template>
    <el-container class="base-body">
        <el-main>
            <h1 class="title title1">关于</h1>
            <p class="paragraph">Management System的作者是万福熊</p>

            <el-divider/>

            <h2 class="title title2">写在前面</h2>
            <p class="paragraph">本项目暂不开源，如有需要，
                <a class="base-link" href="https://www.wanfuxiong.com/wechat" target="_blank">点击这里添加我的微信。</a>
            </p>

            <el-divider/>

            <h2 class="title title2">简介</h2>
            <p class="paragraph">Management System是一个管理数据的模板程序，可以在此基础上继续实现其它需要的功能。</p>
            <el-divider/>

            <h2 class="title title2">感谢巨人</h2>
            <div id="thanks">
            ...
            <h2 class="title title2">详细介绍</h2>
            <h3 class="title title3">技术背景</h3>
            <ul>
                <li>
                    <span class="emoji">💪</span>
                    <el-link :underline="false" href="https://element-plus.gitee.io/zh-CN/" type="primary">Element Plus</el-link>
                </li>
                <li>
                    <span class="emoji">🔥</span>
                    <el-link :underline="false" href="https://www.typescriptlang.org/" type="primary">TypeScript</el-link>
                </li>
                <li>
                    <span class="emoji">🔥</span>
                    <el-link :underline="false" href="https://vitejs.cn/" type="primary">Vite</el-link>
                </li>
                <li>
                    <span class="emoji">💪</span>
                    <el-link :underline="false" href="https://v3.cn.vuejs.org/" type="primary">Vue3</el-link>
                </li>
            </ul>
            <br/>

            <h3 class="title title3">开发环境</h3>
            <ul>
                <li class="paragraph">系统：Windows 10 专业版 64位</li>
                <li class="paragraph">硬件：Intel处理器 + 16GB内存 + 1TB固态</li>
                <li class="paragraph">浏览器：微软Edge（Chrome内核）</li>
                <li class="paragraph">Node.js：16.13.2</li>
                <li class="paragraph">yarn：1.22.17</li>
                <li class="paragraph">vue/cli：4.5.14</li>
            </ul>
        </el-main>
    </el-container>
</template>
